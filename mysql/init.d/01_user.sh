...
create_user() {
    ...
    CREATE USER '${DB_ARC_USER}${SIZE_FACTOR_NAME}'@'%' IDENTIFIED WITH mysql_native_password BY '${DB_ARC_PW}';
    CREATE USER '${DB_ARC_USER}${SIZE_FACTOR_NAME}'@'127.0.0.1' IDENTIFIED WITH mysql_native_password BY '${DB_ARC_PW}';
EOF
